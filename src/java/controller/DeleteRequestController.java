 ...
 * @author 84376
 */
@WebServlet(name="DeleteRequestController", urlPatterns={"/deleteR"})
public class DeleteRequestController extends HttpServlet {
    ...
    throws ServletException, IOException {
         String[] selectedRequestIDs = request.getParameterValues("requestIDs");
        
        if (selectedRequestIDs != null) {
            viewRequestDAO v = new viewRequestDAO();
            for (String requestID : selectedRequestIDs) {
                v.deleteRequest(Integer.parseInt(requestID));
 }
        }
