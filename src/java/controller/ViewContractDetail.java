...
import dal.ViewContractDetailsDAO;
 ...
 * @author 84376
 */
@WebServlet(name="ViewContractDetail", urlPatterns={"/viewContractDetails"})
public class ViewContractDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ViewContractDetailsDAO contractDAO = new ViewContractDetailsDAO();
        List<ViewContractDetails> contracts = contractDAO.getContractsByUserId(customer.getUserID());

        request.setAttribute("contracts", contracts);
        request.getRequestDispatcher("contractDetails.jsp").forward(request, response);
            }
